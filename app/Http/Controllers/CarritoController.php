...
use App\Models\Producto; // Modelo de productos, asegúrate de tenerlo
...
class CarritoController extends Controller
{
    ...
    public function addToCart(Request $request)
    {
        ...
        $carrito = Carrito::updateOrCreate(
            ['cart_token' => $cartToken, 'idProducto' => $productId],
    ...
    public function getCart(Request $request)
    {
        ...
        if ($carrito->isEmpty()) {
            return response()->json(['success' => false, 'message' => 'Carrito vacío o no encontrado'], 404);
        }
